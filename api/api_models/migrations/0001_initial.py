    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('No Iniciado', 'No Iniciado'), ('En proceso', 'En proceso'), ('Terminado', 'Terminado'), ('Saliendo', 'Saliendo')], default='No Iniciado', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('costo_produccion', models.FloatField(default=30.0, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('borrado', models.BooleanField(default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto_variante', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ubicacion_producto', to='api_models.producto_variante')),
            ],
        ),
        migrations.CreateModel(
            name='Trabajador',
            fields=[
                ...
                ('tipo_contrato', models.CharField(choices=[('Tiempo parcial', 'Tiempo parcial'), ('Tiempo completo', 'Tiempo completo')], default='Tiempo completo', max_length=30)),
                ('cargo', models.CharField(default='Ninguno', max_length=50)),
                ('fecha_nacimiento', models.DateField(null=True)),
                ('borrado', models.CharField(default=0, max_length=1)),
                ('area', models.ForeignKey(default=api_models.models.get_default_area, null=True, on_delete=django.db.models.deletion.CASCADE, to='api_models.areas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trabajador', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api_models.trabajador')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estdo_produccion_prod', models.CharField(choices=[('Cancelado', 'Cancelado'), ('No Iniciado', 'No Iniciado'), ('En proceso', 'En proceso'), ('Terminado', 'Terminado'), ('Saliendo', 'Saliendo')], default='No Iniciado', max_length=100)),
