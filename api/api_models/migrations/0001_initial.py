    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', cloudinary.models.CloudinaryField(blank=True, default='https://res.cloudinary.com/dm8aqmori/image/upload/v1675258144/samples/erp/Blancos_jjbcfv.png', max_length=255, null=True, verbose_name='imagen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen_fac_compra', cloudinary.models.CloudinaryField(blank=True, default='https://res.cloudinary.com/dm8aqmori/image/upload/v1675258144/samples/erp/Blancos_jjbcfv.png', max_length=255, null=True, verbose_name='imagen_fac_compra')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad', models.IntegerField(default=0)),
                ('articulo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_models.articulos')),
