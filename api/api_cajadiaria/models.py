...
class Caja_Diaria (models.Model):
    ...
    responsable_apertura = models.ForeignKey(User, related_name="responsable_apertura", on_delete=models.CASCADE)
    ...
    responsable_cierre = models.ForeignKey(User, related_name="responsable_cierre", on_delete=models.CASCADE, null=True)
